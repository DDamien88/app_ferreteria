...
public class ReporteVentasFragment extends Fragment {
    ...
    private ReporteVentasViewModel mViewModel;

    public static ReporteVentasFragment newInstance() {
        return new ReporteVentasFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(ReporteVentasViewModel.class);
